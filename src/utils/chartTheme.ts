 ...
 */
function barChartTooltipRenderer(params: any): {
  data: { label: string; value: string }[];
  symbol?: { marker: { shape: string } };
} {
 ...
 */
function pieTooltipRenderer(params: any): {
  data: { label?: string; value: string }[];
  title?: string;
  symbol?: { marker: { shape: string } };
} {
 ...
 */
function sectorLabelFormatter(params: any): string {
 ...
 */
export function createChartTheme(integrated = false): Record<string, any> {
