  ...
  <div class="dashboard-toolbar">
    <div class="dashboard-toolbar-left">
      ...
      <div v-if="!hidePeriod" class="period-picker-wrapper">
        <PButton v-tooltip.bottom="t('toolbar.selectPeriod')" size="small" rounded @click="togglePopover">
          <template #default>
            <i class="pi pi-calendar" />
            <span class="period-picker-btn-label">{{ periodButtonLabel }}</span>
            ...
            <div class="date-inputs-wrapper">
              <div class="date-input-group">
                ...
                <PDatePicker
                  ...
                  fluid
                />
                <small v-if="validationErrors.dateFrom" class="date-input-error">
              ...
              <div class="date-input-group">
                ...
                <PDatePicker
                  ...
                  fluid
                />
                <small v-if="validationErrors.dateTo" class="date-input-error">
