<template>
  <div class="dashboard-wrapper" :class="{ 'edit-mode': editModeActive }">
    ...
    <div class="dashboard-content" :class="{ 'edit-mode-active': editModeActive }">
          ...
          >
            ...
            >
              <WidgetKpi
                ...
                :widget-data="getWidgetData(item.i) as any"
...
import { WidgetChart, WidgetKpi } from "@/components/widgets";
...
import DashboardPalette from "./DashboardPalette.vue";
...
const widgetItems = ref<DashboardWidget[]>([...props.initialWidgets]);
const paletteWidgets = ref<DashboardWidget[]>([...props.initialPaletteWidgets]);
...
function onResetDashboard() {
  ...
  widgetItems.value = [...props.initialWidgets];
  paletteWidgets.value = [...props.initialPaletteWidgets];
