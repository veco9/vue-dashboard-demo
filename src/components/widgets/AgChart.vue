<template>
  <ag-charts ref="chartRef" :options="chartOptions as any" />
</template>
...
import type { KpiCardProps } from "./KpiCard.vue";
...
const horizontal = computed(
  () =>
    props.series?.some((item: any) => "direction" in item && item.direction == "horizontal") ??
    false,
);
 ...
 */
async function downloadChart(fileName: string = "chart", fileFormat: "image/png" | "image/jpeg" = "image/png") {
